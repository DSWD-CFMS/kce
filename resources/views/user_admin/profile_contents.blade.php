...
<!-- FILES -->
	<div class="row wrapper page-heading animated fadeInRight mt-5" ng-init="show_profile()">
    <div class="col-lg-4">
      ...
      <div class="widget-head-color-box rounded-0 p-lg pt-3">
        <div class="row">
          ...
          <div id="info" ng-if="try_update_profileinfo_btn == false" ng-cloak>
            ...
            <p class="mt-0">
                This account can overseen assigned subprojects. Emnroll and Delete accounts. Entry subproject data.
            </p>
