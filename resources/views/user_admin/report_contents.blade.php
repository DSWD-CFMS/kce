<!-- MODALITY -->
<div class="row wrapper border-bottom white-bg page-heading justify-content-end animated fadeInRight" ng-init="fetch_admin_reports();show_profile()">
	<div class="col-lg-9">
	  <h2> Reports </h2>
	  <ol class="breadcrumb">
	...
	<div class="col-lg-3" style="margin-top: 40px;">
	  <div class="input-group">
	    <div class="input-group-prepend">
	      <button class="btn btn-outline-secondary rounded-0" ng-click="fetch_admin_reports();clearFilter()"> <i class="fa fa-eraser"></i> </button>
	    </div>
...
@include('user_admin.reports_list')
@include('user_admin.reports_modal')
