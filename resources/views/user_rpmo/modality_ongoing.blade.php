...
<div class="tab-pane fade" id="nav-home" role="tabpanel" aria-labelledby="nav-home-tab">
	...
	<div class="row mt-2">
	<div ng-class="{'col-lg-5' : sp_per_modality_data_all_sp_logs.data[0].assigned_grouping == 4, 'col-lg-6' : sp_per_modality_data_all_sp_logs.data[0].assigned_grouping != 4}"> <b style="font-size: .7em;">TITLE</b> <hr> </div>
	<!-- if naay cadt -->
	<div class="col-lg-1" ng-if="sp_per_modality_data_all_sp_logs.data[0].assigned_grouping == 4"> <b style="font-size: .7em;">CADT</b> <hr> </div>
	...
	@verbatim
<div id="accordion1">
  	<div class="row accordion_row remove_high_light" style="cursor: pointer; padding-top: 10px;padding-bottom:10px;"  ng-repeat="all_data in bars = (sp_per_modality_data_all_sp_logs.data | filter: search_data_modality.$)">
		...
		<div class="col-lg-1" ng-if="sp_per_modality_data_all_sp_logs.data[0].assigned_grouping == 4">
			<span ng-bind="all_data.sp[0].cadt.cadt_no | uppercase"></span>
		</div>
  		...
  		<div class="col-lg-1">
  			<a href="" class="btn btn-outline-primary rounded-0" style="text-decoration: none !important; text-transform: none !important;" data-toggle="collapse" data-target="#collapseExample{{all_data.sp[0].sp_id}}" aria-expanded="true" aria-controls="collapseExample{{all_data.sp[0].sp_id}}" ng-click="view_specific_sp_data(sp_per_modality_data_on_going.data[$index]);cancel_update_sp();check_if_completed(sp_per_modality_data_all_sp_logs.data[$index])">
  				More...
  			</a>
  		</div>
  		<div class="col-lg-12 accordion1_ongoing">
			<div class="container-fluid collapse" aria-labelledby="collapseExample{{all_data.sp[0].sp_id}}" id="collapseExample{{all_data.sp[0].sp_id}}" data-parent="#accordion1" style="border-top: solid 3px #ff9c07; border-bottom: solid 3px #ff9c07; margin-bottom: 50px; padding: 0px !important;">
				<div class="row">
					<div class="col-lg-6">
						<div class="row">
