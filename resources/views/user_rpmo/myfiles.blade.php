...
<div class="row wrapper border-bottom white-bg page-heading justify-content-center animated fadeInRight" ng-init="fetch_my_all_file()">

	<div class="col-lg-9">
		<h2> Uploads </h2>
		<ol class="breadcrumb">
		  <li class="breadcrumb-item">
		    <a href="{{ url('/admin_rcis/routes') }}" >Dashboard</a>
		  </li>
		  <li class="breadcrumb-item">
	...
	<div class="col-lg-3">
		...
		<div class="input-group">
			...
			<div class="input-group-prepend">
        		<a class="btn btn-outline-secondary rounded-0" href="{{ url('/rpmo/routes/files') }}"> Upload a file <i class="fa fa-upload"></i> </a>
			</div>						
		</div>
	</div>
