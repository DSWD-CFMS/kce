...
<div id="page-wrapper" class="gray-bg dashbard-1" ng-init="fetch_rpmo_upload();show_profile()">
              ...
              <div class="row">
                <div class="col-lg-3" ng-repeat="all_files in my_all_file_data | filter: search_data.name | filter: search_data.category">
                  ...
                  <p class="py-2 pl-2" style="border-left:solid 2px #007bff;">
                    ...
                    <button class="btn btn-outline-primary btn-sm mt-1" style="border-radius: 16px;"> <i class="fa fa-download"></i> <a class="text-light" href="/rpmo/routes/download/{{all_files.id}}"> Download </a> </button>

                    <button class="btn btn-outline-danger btn-sm mt-1" style="border-radius: 16px;"> <i class="fa fa-trash"></i> <a class="text-light" > Delete </a> </button>
                  </p>
                  @endverbatim
                </div>
              </div>
