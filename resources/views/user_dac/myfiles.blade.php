	...
	<div class="col-lg-3">
		...
		<div class="input-group">
			<div class="input-group-prepend">
			  <a class="btn btn-outline-secondary rounded-0" href="{{ url('/dac/routes/files/myfiles') }}"> My files <i class="fa fa-inbox"></i> </a>
			</div>
			<a class="btn btn-outline-secondary rounded-0" href="{{ url('/dac/routes/files/allfiles') }}"> All files <i class="fa fa-files-o"></i> </a>
			<div class="input-group-prepend">
        		<a class="btn btn-outline-secondary rounded-0" href="{{ url('/dac/routes/files') }}"> Upload a file <i class="fa fa-upload"></i> </a>
			</div>						
		</div>
	</div>
