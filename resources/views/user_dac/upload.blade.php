...
<div id="page-wrapper" class="gray-bg dashbard-1" ng-init="fetch_dac_upload();show_profile()">
...
<div class="row justify-content-center">
  ...
  <div class="col-lg-10" style="border-left: solid 2px #eeeeee66; height: 100%;">
    <div class="row">
      <div class="col-lg-12">
        <!-- Nav tabs -->
            ...
            <div class="row">
              ...
              <div class="col-lg-4" ng-repeat="files in file_data">
                <p class="py-2 pl-2" style="border-left:solid 2px #007bff;">
                  ...
                  <small ng-if="files.sp_id != null"> <b>Subproject ID:</b> <span ng-bind="files.sp_id"></span> </small> <br>
