...
<!-- Add Files -->
<div class="modal fade" id="add_files" tabindex="-1" role="dialog">
    ...
    <div class="modal-content rounded-0">
      <div class="modal-body pb-0" style="padding: 16px !important;">
        ...
        <div class="form-group shadow1">
          <h2 class="mt-0 mb-3 text-center"> Choose a file type </span></h2>
          <select id="inputState" class="form-control" ng-model="filetype">
              <option value="SP_files_BP" selected> Building Permit </option>
              <option value="SP_files_FP"> Fullblown Proposal </option>
              <option value="SP_files_VO"> Variation Order </option>
              <option value="SP_files_MT"> Materials Testing </option>
              <option value="SP_files_EMSR"> ESMR </option>
              <option value="SP_files_CSR"> CSR </option>
              <option value="SP_files_SPCR"> SPCR </option>
              <option value="SP_files_SPOTCHECK"> Spot Check </option>
              <option value="SP_files_SUSPENSION_ORDER"> Suspension Order </option>
              <option value="SP_files_TIME_EXTENSION"> Time Extension </option>
          </select>
        </div>

        <div class="form-group mb-5" ng-if="filetype != null || filetype != 'undefined' || filetype != '' || file_upload.length != 0 || file_upload.length != null">
      ...
      <div class="modal-footer justify-content-between">
        <button class="btn btn-primary mr-auto" style="border-radius: 0px;" ng-disabled="filetype == null || filetype == '' || file_upload.length == 0 || file_upload.length == null" ng-click="upload_file_per_sp(filetype,specific_sp_data.sp_id)"> <i class="fa fa-upload"></i> Upload</button>
...
<!-- Updating -->
<div class="modal fade" id="update_Sp" tabindex="-1" role="dialog">
  <div class="modal-dialog modal-lg" role="document">
    <div class="modal-content rounded-0">
      <div class="modal-header pb-0">
        <h4 class="modal-title">
          <span class="font-weight-light">You're updating SP : <span class="font-weight-light text-primary" ng-bind="specific_sp_data.sp_id"> </span> </span>
          <p ng-bind="specific_sp_data.sp[0].sp_title"></p>
        </h4>
      </div>
      <div class="modal-body pb-0" style="padding: 16px !important;">
        <div class="row">
        ...
        <div class="row">
          <div class="col hov">
            ...
            <textarea class="form-control text_area" id="msg" rows="8" maxlength="255" style="resize: none;overflow-x: auto;" ng-model="$parent.iss_prob"></textarea>
            <br>
          </div>

          <div class="col hov">
            <small class="text-label-blue"> <b> Analysis </b> </small>
            <textarea class="form-control text_area" id="msg" rows="8" maxlength="255" style="resize: none;overflow-x: auto;" ng-model="$parent.analyis"></textarea>
            <br>
          </div>

          <div class="col hov">
            <small class="text-label-blue"> <b> Remarks </b> </small>
            <textarea class="form-control text_area" id="msg" rows="8" maxlength="255" style="resize: none;overflow-x: auto;" ng-model="$parent.remarks"></textarea>
            <br>
          </div>
        </div>
      </div>
      <div class="modal-footer justify-content-between">
        <button type="button" data-dismiss="modal" class="btn btn-outline-danger btn-sm rounded-0 mr-auto" ng-click="cancel_update_sp()"> <i class="fa fa-times"></i> Cancel changes</button>

        <button ng-disabled="$parent.iss_prob.length == 0 || $parent.iss_prob == undefined && $parent.analyis.length == 0 || $parent.analyis == undefined && $parent.remarks.length == 0 || $parent.remarks == undefined && actual_shit.length == 0 || actual_shit == undefined" type="button" class="btn btn-outline-success btn-sm  rounded-0" data-dismiss="modal" ng-click="update_sp(specific_sp_logs_length[0].id,actual_shit,Slippage_data,iss_prob,analyis,remarks,specific_sp_data.sp_id)"> <i class="fa fa-clipboard"></i> Save changes</button>
      </div>
    </div>
  </div>
</div>
...
<div class="modal fade" id="planned_modal" tabindex="-1" role="dialog">
  <div class="modal-dialog" role="document">
    <div class="modal-content">
      ...
      <div class="modal-footer justify-content-between">
        <button type="button" class="btn btn-primary mr-auto" data-dismiss="modal" data-toggle="collapse" data-target="#collapseExample{{collapse_id}}" ng-click="create_planned_logs(planned_data,specific_sp_data.sp_id)">Save changes</button>
  ...
  <div class="modal-dialog modal-full" role="document">
    <div class="modal-content">
      <div class="modal-header border-0">
        <h3 class="modal-title"><span ng-bind="(specific_sp_data.sp[0].sp_title) +' - '+ (specific_sp_data.sp[0].sp_brgy) +', '+ (specific_sp_data.sp[0].sp_municipality)"></span></h3>
        <button type="button" class="close" data-dismiss="modal" aria-label="Close">
          <span aria-hidden="true">&times;</span>
        </button>
      </div>
...
<!-- PMR History Viewing -->
<div class="modal fade" id="pmr_history_modal" tabindex="-1" role="dialog">
  <div class="modal-dialog modal-lg" role="document">
    <div class="modal-content">
      <div class="modal-header" style="padding: 20px 30px 10px 30px !important;">
        <div class="row">
          <div class="col-lg-12">
            <h2 class="font-weight-bold my-0">PMR - SP ID: <span ng-bind="specific_pmr_data.sp_id"></span> <br>
            </h2>
            <h5 class="mb-0 font-weight-light">STATUS: <span style="color:#007bff;" ng-bind="specific_pmr_data.status | uppercase"></span></h5>
          </div>

          <div class="col-lg-12">
            <h5 ng-bind="specific_sp_data.sp[0].sp_title"></h5>
          </div>
        </div>
      </div>
      <div class="modal-body pb-0">
        ...
        <div class="row">
          <div class="col-lg-3">
            <div class="form-group">
              <label style="color:#007bff;"><small class="col-form-label"> <small class="font-weight-bold"> Mode of Procurement </small> </small></label>
              <p class="mb-0" ng-if="pmr_update_inputs == false" ng-bind="specific_pmr_data.mode_of_procurement"></p>

              <select class="form-control" ng-if="pmr_update_inputs == true" id="batch" ng-model="specific_pmr_data_for_update.mode_of_procurement">
                  <option value="COMPETITIVE BIDDING - FOR GOODS" selected="true"> COMPETITIVE BIDDING - FOR GOODS </option>
                  <option value="COMPETITIVE BIDDING - FOR INFRASTRUCTURE"> COMPETITIVE BIDDING - FOR INFRASTRUCTURE </option>
                  <option value="NP-53.1 TWO FAILED BIDDINGS"> NP-53.1 TWO FAILED BIDDINGS </option>
          ...
          <div class="col-lg-3">
            <div class="form-group">
              <label style="color:#007bff;"><small class="col-form-label"> <small class="font-weight-bold"> CODE (PAP) </small> </small></label>
              <p class="mb-0" ng-if="pmr_update_inputs == false" ng-bind="specific_pmr_data.code"></p>

              <input ng-if="pmr_update_inputs == true" ng-model="specific_pmr_data_for_update.code" type="text" class="form-control" aria-describedby="codepap" placeholder="Ex. Lot 1...">
            </div>
          </div>

          <div class="col-lg-3">
            <div class="form-group">
              <label style="color:#007bff;"><small class="col-form-label"> <small class="font-weight-bold"> NATURE OF PROCUREMENT </small> </small></label>
              <p class="mb-0" ng-if="pmr_update_inputs == false" ng-bind="specific_pmr_data.nature_of_procurement"></p>

              <input ng-if="pmr_update_inputs == true" ng-model="specific_pmr_data_for_update.nature_of_procurement" type="text" class="form-control" aria-describedby="codepap" placeholder="Ex. Lot 1...">
            </div>
          </div>

          <div class="col-lg-3">
            <div class="form-group">
              <label style="color:#007bff;"><small class="col-form-label"> <small class="font-weight-bold"> Source of Funds (WB/GOP) </small> </small></label>
              <p class="mb-0" ng-if="pmr_update_inputs == false" ng-bind="specific_pmr_data.fund_source"></p>

              <select ng-if="pmr_update_inputs == true" class="form-control" id="batch" ng-model="specific_pmr_data_for_update.fund_source">
                  <option value="WB" selected="true"> WB </option>
                  <option value="GOP"> GOP </option>
              </select>              
            </div>
        ...
        <div class="row" ng-if="pmr_update_inputs == false">
          <div class="col-lg-12">
            <h3>Actual Procurement Activity</h3>
          </div>
          ...
          <div class="col-lg-3">
            <div class="form-group">
              <label style="color:#007bff;"><small class="col-form-label"> <small class="font-weight-bold"> Pre-Proc Conference </small> </small></label>
              <p class="mb-0" ng-if="specific_pmr_data.apa_pre_proc_con != 'Invalid Date'">
                <span ng-bind="specific_pmr_data.apa_pre_proc_con | date: 'mediumDate'"></span>
              </p>
              <p class="mb-0" ng-if="specific_pmr_data.apa_pre_proc_con == 'Invalid Date'" >NOT APPLICABLE</p>
              <p>
                <a ng-if="specific_pmr_data.apa_pre_proc_con == 'Invalid Date'" href="" style="text-transform: none !important;" class="text-warning" ng-click="pmr_update_single_data('apa_pre_proc_con',specific_pmr_data.id)"> <i class="fa fa-pencil-square-o"></i> Update </a>
              </p>
            </div>
          </div>
          ...
          <div class="col-lg-3">
            <div class="form-group">
              <label style="color:#007bff;"><small class="col-form-label"> <small class="font-weight-bold"> Ads/Post of IAEB </small> </small></label>
               <!-- ng-if="specific_pmr_data.apa_ads != 'Invalid Date'" -->
              <p class="mb-0" ng-if="specific_pmr_data.apa_ads != 'Invalid Date'">
                <span ng-bind="specific_pmr_data.apa_ads | date: 'mediumDate'"></span>
              </p>

              <p class="mb-0" ng-if="specific_pmr_data.mode_of_procurement == 'NP-53.9 SMALL VALUE PROCUREMENT' || specific_pmr_data.mode_of_procurement == 'SHOPPING' || specific_pmr_data.mode_of_procurement == 'NP-53.2 EMERGENCY CASES'" >NOT APPLICABLE</p>
              <p>
                <a ng-if="specific_pmr_data.apa_ads == 'Invalid Date' && specific_pmr_data.mode_of_procurement == 'COMPETITIVE BIDDING - FOR GOODS' || specific_pmr_data.mode_of_procurement == 'COMPETITIVE BIDDING - FOR INFRASTRUCTURE' || specific_pmr_data.mode_of_procurement == 'NP-53.12 COMMUNITY PARTICIPATION' || specific_pmr_data.mode_of_procurement == 'NP-53.1 TWO FAILED BIDDINGS'" href="" style="text-transform: none !important;" class="text-warning" ng-click="pmr_update_single_data('apa_ads',specific_pmr_data.id)"> <i class="fa fa-pencil-square-o"></i> Update </a>
              </p>
            </div>
          </div>
          ...
          <div class="col-lg-3">
            <div class="form-group">
              <label style="color:#007bff;"><small class="col-form-label"> <small class="font-weight-bold"> Pre-bid Conf </small> </small></label>
              <p class="mb-0" ng-if="specific_pmr_data.apa_prebid_con != 'Invalid Date'" ng-bind="specific_pmr_data.apa_prebid_con | date: 'mediumDate'"></p>
              <p class="mb-0" ng-if="specific_pmr_data.mode_of_procurement == 'NP-53.1 TWO FAILED BIDDINGS' || specific_pmr_data.mode_of_procurement == 'NP-53.9 SMALL VALUE PROCUREMENT' || specific_pmr_data.mode_of_procurement == 'SHOPPING' || specific_pmr_data.mode_of_procurement == 'NP-53.2 EMERGENCY CASES'" >NOT APPLICABLE</p>

              <p>
                <a ng-if="specific_pmr_data.apa_prebid_con == 'Invalid Date' && specific_pmr_data.mode_of_procurement == 'COMPETITIVE BIDDING - FOR GOODS' || specific_pmr_data.mode_of_procurement == 'COMPETITIVE BIDDING - FOR INFRASTRUCTURE' || specific_pmr_data.mode_of_procurement == 'COMPETITIVE BIDDING - FOR INFRASTRUCTURE' || specific_pmr_data.mode_of_procurement == 'NP-53.12 COMMUNITY PARTICIPATION'" href="" style="text-transform: none !important;" class="text-warning" ng-click="pmr_update_single_data('apa_prebid_con',specific_pmr_data.id)"> <i class="fa fa-pencil-square-o"></i> Update </a>
              </p>
            </div>
          </div>
          ...
          <div class="col-lg-3">
            <div class="form-group">
              <label style="color:#007bff;"><small class="col-form-label"> <small class="font-weight-bold"> Eligibility Check </small> </small></label>
              <p class="mb-0" ng-if="specific_pmr_data.apa_eligibility_check != 'Invalid Date'" ng-bind="specific_pmr_data.apa_eligibility_check | date: 'mediumDate'"></p>
              <p class="mb-0" ng-if="specific_pmr_data.mode_of_procurement == 'NP-53.1 TWO FAILED BIDDINGS' || specific_pmr_data.mode_of_procurement == 'NP-53.9 SMALL VALUE PROCUREMENT' || specific_pmr_data.mode_of_procurement == 'SHOPPING'" >NOT APPLICABLE</p>
              <p>
                <a ng-if="specific_pmr_data.apa_eligibility_check == 'Invalid Date' && specific_pmr_data.mode_of_procurement == 'COMPETITIVE BIDDING - FOR GOODS' || specific_pmr_data.mode_of_procurement == 'COMPETITIVE BIDDING - FOR INFRASTRUCTURE' || specific_pmr_data.mode_of_procurement == 'COMPETITIVE BIDDING - FOR INFRASTRUCTURE' || specific_pmr_data.mode_of_procurement == 'NP-53.12 COMMUNITY PARTICIPATION'" href="" style="text-transform: none !important;" class="text-warning" ng-click="pmr_update_single_data('apa_eligibility_check',specific_pmr_data.id)"> <i class="fa fa-pencil-square-o"></i> Update </a>
              </p>
          ...
          <div class="col-lg-3">
            <div class="form-group">
              <label style="color:#007bff;"><small class="col-form-label"> <small class="font-weight-bold"> Sub/Open of Bids </small> </small></label>
              <p class="mb-0" ng-if="specific_pmr_data.apa_open_of_bids != 'Invalid Date'" ng-bind="specific_pmr_data.apa_open_of_bids | date: 'mediumDate'"></p>
              <!-- <p class="mb-0" ng-if="specific_pmr_data.apa_open_of_bids == 'Invalid Date'" >NOT APPLICABLE</p> -->
              <p>
                <a ng-if="specific_pmr_data.apa_open_of_bids == 'Invalid Date'" href="" style="text-transform: none !important;" class="text-warning" ng-click="pmr_update_single_data('apa_open_of_bids',specific_pmr_data.id)"> <i class="fa fa-pencil-square-o"></i> Update </a>
              </p>
            </div>
          </div>
          ...
          <div class="col-lg-3">
            <div class="form-group">
              <label style="color:#007bff;"><small class="col-form-label"> <small class="font-weight-bold"> Bid Evaluation </small> </small></label>
              <p class="mb-0" ng-if="specific_pmr_data.apa_bid_eval != 'Invalid Date'" ng-bind="specific_pmr_data.apa_bid_eval | date: 'mediumDate'"></p>
              <!-- <p class="mb-0" ng-if="specific_pmr_data.apa_bid_eval == 'Invalid Date'" >NOT APPLICABLE</p> -->
              <p>
                <a ng-if="specific_pmr_data.apa_bid_eval == 'Invalid Date'" href="" style="text-transform: none !important;" class="text-warning" ng-click="pmr_update_single_data('apa_bid_eval',specific_pmr_data.id)"> <i class="fa fa-pencil-square-o"></i> Update </a>
              </p>
            </div>
          </div>
          ...
          <div class="col-lg-3">
            <div class="form-group">
              <label style="color:#007bff;"><small class="col-form-label"> <small class="font-weight-bold"> Post Qual </small> </small></label>
              <p class="mb-0" ng-if="specific_pmr_data.apa_post_qual != 'Invalid Date'" ng-bind="specific_pmr_data.apa_post_qual | date: 'mediumDate'"></p>
              <p class="mb-0" ng-if="specific_pmr_data.mode_of_procurement == undefined || specific_pmr_data.mode_of_procurement == 'NP-53.1 TWO FAILED BIDDINGS' || specific_pmr_data.mode_of_procurement == 'NP-53.9 SMALL VALUE PROCUREMENT' || specific_pmr_data.mode_of_procurement == 'SHOPPING' || specific_pmr_data.mode_of_procurement == 'NP-53.2 EMERGENCY CASES'" >NOT APPLICABLE</p>

              <p>
                <a ng-if="specific_pmr_data.apa_post_qual == 'Invalid Date' && specific_pmr_data.mode_of_procurement == 'COMPETITIVE BIDDING - FOR GOODS' || specific_pmr_data.mode_of_procurement == 'COMPETITIVE BIDDING - FOR INFRASTRUCTURE' || specific_pmr_data.mode_of_procurement == 'COMPETITIVE BIDDING - FOR INFRASTRUCTURE' || specific_pmr_data.mode_of_procurement == 'NP-53.12 COMMUNITY PARTICIPATION'" href="" style="text-transform: none !important;" class="text-warning" ng-click="pmr_update_single_data('apa_post_qual',specific_pmr_data.id)"> <i class="fa fa-pencil-square-o"></i> Update </a>
              </p>
            </div>
          </div>
          ...
          <div class="col-lg-3">
            <div class="form-group">
              <label style="color:#007bff;"><small class="col-form-label"> <small class="font-weight-bold"> BAC Reso. Recom. Award </small> </small></label>
              <p class="mb-0" ng-if="specific_pmr_data.bac_reso_recom_award != 'Invalid Date'" ng-bind="specific_pmr_data.bac_reso_recom_award | date: 'mediumDate'"></p>
              <p class="mb-0" ng-if="specific_pmr_data.mode_of_procurement == undefined" >NOT APPLICABLE</p>

              <p>
                <a ng-if="specific_pmr_data.bac_reso_recom_award == 'Invalid Date'" href="" style="text-transform: none !important;" class="text-warning" ng-click="pmr_update_single_data('bac_reso_recom_award',specific_pmr_data.id)"> <i class="fa fa-pencil-square-o"></i> Update </a>
              </p>
            </div>
          </div>
          ...
          <div class="col-lg-3">
            <div class="form-group">
              <label style="color:#007bff;"><small class="col-form-label"> <small class="font-weight-bold"> Notice of Award </small> </small></label>
              <p class="mb-0" ng-if="specific_pmr_data.apa_notice_of_award != 'Invalid Date'" ng-bind="specific_pmr_data.apa_notice_of_award | date: 'mediumDate'"></p>

              <p class="mb-0" ng-if="specific_pmr_data.mode_of_procurement == undefined || specific_pmr_data.mode_of_procurement == 'NP-53.1 TWO FAILED BIDDINGS' || specific_pmr_data.mode_of_procurement == 'NP-53.9 SMALL VALUE PROCUREMENT' || specific_pmr_data.mode_of_procurement == 'SHOPPING'" >NOT APPLICABLE</p>

              <p>
                <a ng-if="specific_pmr_data.apa_notice_of_award == 'Invalid Date' && specific_pmr_data.mode_of_procurement == 'COMPETITIVE BIDDING - FOR GOODS'" href="" style="text-transform: none !important;" class="text-warning" ng-click="pmr_update_single_data('apa_notice_of_award',specific_pmr_data.id)"> <i class="fa fa-pencil-square-o"></i> Update </a>

                <a ng-if="specific_pmr_data.apa_notice_of_award == 'Invalid Date' && specific_pmr_data.mode_of_procurement == 'COMPETITIVE BIDDING - FOR INFRASTRUCTURE'" href="" style="text-transform: none !important;" class="text-warning" ng-click="pmr_update_single_data('apa_notice_of_award',specific_pmr_data.id)"> <i class="fa fa-pencil-square-o"></i> Update </a>

                <a ng-if="specific_pmr_data.apa_notice_of_award == 'Invalid Date' && specific_pmr_data.mode_of_procurement == 'NP-53.12 COMMUNITY PARTICIPATION'" href="" style="text-transform: none !important;" class="text-warning" ng-click="pmr_update_single_data('apa_notice_of_award',specific_pmr_data.id)"> <i class="fa fa-pencil-square-o"></i> Update </a>

                <a ng-if="specific_pmr_data.apa_notice_of_award == 'Invalid Date' && specific_pmr_data.mode_of_procurement == 'NP-53.2 EMERGENCY CASES' " href="" style="text-transform: none !important;" class="text-warning" ng-click="pmr_update_single_data('apa_notice_of_award',specific_pmr_data.id)"> <i class="fa fa-pencil-square-o"></i> Update </a>
              </p>
          ...
          <div class="col-lg-3">
            <div class="form-group">
              <label style="color:#007bff;"><small class="col-form-label"> <small class="font-weight-bold"> Contract Signing </small> </small></label>
              <p class="mb-0" ng-if="specific_pmr_data.apa_contract_signing != 'Invalid Date'"  ng-bind="specific_pmr_data.apa_contract_signing | date: 'mediumDate'"></p>
              <!-- <p class="mb-0" ng-if="specific_pmr_data.apa_contract_signing == 'Invalid Date'" >NOT APPLICABLE</p> -->
              <p class="mb-0" ng-if="specific_pmr_data.mode_of_procurement == undefined || specific_pmr_data.mode_of_procurement == 'NP-53.1 TWO FAILED BIDDINGS' || specific_pmr_data.mode_of_procurement == 'NP-53.9 SMALL VALUE PROCUREMENT' || specific_pmr_data.mode_of_procurement == 'SHOPPING'" >NOT APPLICABLE</p>

              <p>
                <a ng-if="specific_pmr_data.apa_contract_signing == 'Invalid Date' && specific_pmr_data.mode_of_procurement == 'COMPETITIVE BIDDING - FOR GOODS'" href="" style="text-transform: none !important;" class="text-warning" ng-click="pmr_update_single_data('apa_contract_signing',specific_pmr_data.id)"> <i class="fa fa-pencil-square-o"></i> Update </a>

                <a ng-if="specific_pmr_data.apa_contract_signing == 'Invalid Date' && specific_pmr_data.mode_of_procurement == 'COMPETITIVE BIDDING - FOR INFRASTRUCTURE'" href="" style="text-transform: none !important;" class="text-warning" ng-click="pmr_update_single_data('apa_contract_signing',specific_pmr_data.id)"> <i class="fa fa-pencil-square-o"></i> Update </a>

                <a ng-if="specific_pmr_data.apa_contract_signing == 'Invalid Date' && specific_pmr_data.mode_of_procurement == 'NP-53.12 COMMUNITY PARTICIPATION'" href="" style="text-transform: none !important;" class="text-warning" ng-click="pmr_update_single_data('apa_contract_signing',specific_pmr_data.id)"> <i class="fa fa-pencil-square-o"></i> Update </a>

                <a ng-if="specific_pmr_data.apa_contract_signing == 'Invalid Date' && specific_pmr_data.mode_of_procurement == 'NP-53.2 EMERGENCY CASES'" href="" style="text-transform: none !important;" class="text-warning" ng-click="pmr_update_single_data('apa_contract_signing',specific_pmr_data.id)"> <i class="fa fa-pencil-square-o"></i> Update </a>
              </p>
            </div>
          </div>
          ...
          <div class="col-lg-3">
            <div class="form-group">
              <label style="color:#007bff;"><small class="col-form-label"> <small class="font-weight-bold"> Notice to Proceed </small> </small></label>
              <p class="mb-0" ng-if="specific_pmr_data.apa_notice_to_proceed != 'Invalid Date'" ng-bind="specific_pmr_data.apa_notice_to_proceed | date: 'mediumDate'"></p>
              <!-- <p class="mb-0" ng-if="specific_pmr_data.apa_notice_to_proceed == 'Invalid Date'" >NOT APPLICABLE</p> -->
              <p class="mb-0" ng-if="specific_pmr_data.mode_of_procurement == undefined || specific_pmr_data.mode_of_procurement == 'NP-53.1 TWO FAILED BIDDINGS' || specific_pmr_data.mode_of_procurement == 'NP-53.9 SMALL VALUE PROCUREMENT' || specific_pmr_data.mode_of_procurement == 'SHOPPING' || specific_pmr_data.mode_of_procurement == 'NP-53.2 EMERGENCY CASES'" >NOT APPLICABLE</p>

              <p>
                <a ng-if="specific_pmr_data.apa_prebid_con == 'Invalid Date' && specific_pmr_data.mode_of_procurement == 'COMPETITIVE BIDDING - FOR GOODS'" href="" style="text-transform: none !important;" class="text-warning" ng-click="pmr_update_single_data('apa_notice_to_proceed',specific_pmr_data.id)"> <i class="fa fa-pencil-square-o"></i> Update </a>

                <a ng-if="specific_pmr_data.apa_prebid_con == 'Invalid Date' && specific_pmr_data.mode_of_procurement == 'COMPETITIVE BIDDING - FOR INFRASTRUCTURE'" href="" style="text-transform: none !important;" class="text-warning" ng-click="pmr_update_single_data('apa_notice_to_proceed',specific_pmr_data.id)"> <i class="fa fa-pencil-square-o"></i> Update </a>

                <a ng-if="specific_pmr_data.apa_prebid_con == 'Invalid Date' && specific_pmr_data.mode_of_procurement == 'NP-53.12 COMMUNITY PARTICIPATION'" href="" style="text-transform: none !important;" class="text-warning" ng-click="pmr_update_single_data('apa_notice_to_proceed',specific_pmr_data.id)"> <i class="fa fa-pencil-square-o"></i> Update </a>
              </p>
            </div>
          </div>
          ...
          <div class="col-lg-3">
            <div class="form-group">
              ...
              <p class="mb-0" ng-if="specific_pmr_data.date_of_posting_philgeps_noa != 'Invalid Date'" ng-bind="specific_pmr_data.date_of_posting_philgeps_noa | date: 'mediumDate'"></p>

              <p class="mb-0" ng-if="specific_pmr_data.date_of_posting_philgeps_noa != 'Invalid Date' || specific_pmr_data.mode_of_procurement == 'SHOPPING' || philgeps == false" >NOT APPLICABLE</p>

              <p>
                <a ng-if="specific_pmr_data.date_of_posting_philgeps_noa == 'Invalid Date' && specific_pmr_data.mode_of_procurement != 'SHOPPING' && philgeps == true" href="" style="text-transform: none !important;" class="text-warning" ng-click="pmr_update_single_data('date_of_posting_philgeps_noa',specific_pmr_data.id)"> <i class="fa fa-pencil-square-o"></i> Update </a>
              </p>
            </div>
          </div>
          ...
          <div class="col-lg-3">
            <div class="form-group">
              <label style="color:#007bff;"><small class="col-form-label"> <small class="font-weight-bold"> Contract Review Date </small> </small></label>
              <p class="mb-0" ng-if="specific_pmr_data.apa_contract_review_date != 'Invalid Date'" ng-bind="specific_pmr_data.apa_contract_review_date | date: 'mediumDate'"></p>
              <!-- <p class="mb-0" ng-if="specific_pmr_data.apa_contract_review_date == 'Invalid Date'" >NOT APPLICABLE</p> -->
              <p class="mb-0" ng-if="specific_pmr_data.mode_of_procurement == undefined || specific_pmr_data.mode_of_procurement == 'NP-53.1 TWO FAILED BIDDINGS' || specific_pmr_data.mode_of_procurement == 'NP-53.9 SMALL VALUE PROCUREMENT' || specific_pmr_data.mode_of_procurement == 'SHOPPING'" >NOT APPLICABLE</p>

              <p>
                <a ng-if="specific_pmr_data.apa_contract_review_date == 'Invalid Date' && specific_pmr_data.mode_of_procurement == 'COMPETITIVE BIDDING - FOR GOODS'" href="" style="text-transform: none !important;" class="text-warning" ng-click="pmr_update_single_data('apa_contract_review_date',specific_pmr_data.id)"> <i class="fa fa-pencil-square-o"></i> Update </a>

                <a ng-if="specific_pmr_data.apa_contract_review_date == 'Invalid Date' && specific_pmr_data.mode_of_procurement == 'COMPETITIVE BIDDING - FOR INFRASTRUCTURE'" href="" style="text-transform: none !important;" class="text-warning" ng-click="pmr_update_single_data('apa_contract_review_date',specific_pmr_data.id)"> <i class="fa fa-pencil-square-o"></i> Update </a>

                <a ng-if="specific_pmr_data.apa_contract_review_date == 'Invalid Date' && specific_pmr_data.mode_of_procurement == 'NP-53.12 COMMUNITY PARTICIPATION'" href="" style="text-transform: none !important;" class="text-warning" ng-click="pmr_update_single_data('apa_contract_review_date',specific_pmr_data.id)"> <i class="fa fa-pencil-square-o"></i> Update </a>

                <a ng-if="specific_pmr_data.apa_contract_review_date == 'Invalid Date' && specific_pmr_data.mode_of_procurement == 'NP-53.2 EMERGENCY CASES'" href="" style="text-transform: none !important;" class="text-warning" ng-click="pmr_update_single_data('apa_contract_review_date',specific_pmr_data.id)"> <i class="fa fa-pencil-square-o"></i> Update </a>
          ...
          <div class="col-lg-3">
            <div class="form-group">
              <label style="color:#007bff;"><small class="col-form-label"> <small class="font-weight-bold"> Target Date of Completion </small> </small></label>
              <p class="mb-0" ng-if="specific_pmr_data.apa_target_date_completion != 'Invalid Date'" ng-bind="specific_pmr_data.apa_target_date_completion | date: 'mediumDate'"></p>

              <p>
                <a ng-if="specific_pmr_data.apa_target_date_completion == 'Invalid Date'" href="" style="text-transform: none !important;" class="text-warning" ng-click="pmr_update_single_data('apa_target_date_completion',specific_pmr_data.id)"> <i class="fa fa-pencil-square-o"></i> Update </a>
              </p>
            </div>
          </div>
          ...
          <div class="col-lg-3">
            <div class="form-group">
              <label style="color:#007bff;"><small class="col-form-label"> <small class="font-weight-bold"> Delivery/ Completion </small> </small></label>
              <p class="mb-0" ng-if="specific_pmr_data.apa_delivery != 'Invalid Date'" ng-bind="specific_pmr_data.apa_delivery | date: 'mediumDate'"></p>
              <!-- <p class="mb-0" ng-if="specific_pmr_data.apa_delivery == 'Invalid Date'" >NOT APPLICABLE</p> -->
              <p class="mb-0" ng-if="specific_pmr_data.mode_of_procurement == undefined || specific_pmr_data.mode_of_procurement == 'NP-53.1 TWO FAILED BIDDINGS' || specific_pmr_data.mode_of_procurement == 'NP-53.9 SMALL VALUE PROCUREMENT' || specific_pmr_data.mode_of_procurement == 'SHOPPING'" >NOT APPLICABLE</p>

              <p>
                <a ng-if="specific_pmr_data.apa_prebid_con == 'Invalid Date' && specific_pmr_data.mode_of_procurement == 'COMPETITIVE BIDDING - FOR GOODS'" href="" style="text-transform: none !important;" class="text-warning" ng-click="pmr_update_single_data('apa_delivery',specific_pmr_data.id)"> <i class="fa fa-pencil-square-o"></i> Update </a>

                <a ng-if="specific_pmr_data.apa_prebid_con == 'Invalid Date' && specific_pmr_data.mode_of_procurement == 'COMPETITIVE BIDDING - FOR INFRASTRUCTURE'" href="" style="text-transform: none !important;" class="text-warning" ng-click="pmr_update_single_data('apa_delivery',specific_pmr_data.id)"> <i class="fa fa-pencil-square-o"></i> Update </a>

                <a ng-if="specific_pmr_data.apa_prebid_con == 'Invalid Date' && specific_pmr_data.mode_of_procurement == 'NP-53.12 COMMUNITY PARTICIPATION'" href="" style="text-transform: none !important;" class="text-warning" ng-click="pmr_update_single_data('apa_delivery',specific_pmr_data.id)"> <i class="fa fa-pencil-square-o"></i> Update </a>

                <a ng-if="specific_pmr_data.apa_prebid_con == 'Invalid Date' && specific_pmr_data.mode_of_procurement == 'NP-53.2 EMERGENCY CASES'" href="" style="text-transform: none !important;" class="text-warning" ng-click="pmr_update_single_data('apa_delivery',specific_pmr_data.id)"> <i class="fa fa-pencil-square-o"></i> Update </a>
          ...
          <div class="col-lg-3">
            <div class="form-group">
              <label style="color:#007bff;"><small class="col-form-label"> <small class="font-weight-bold"> Acceptance/ Turnover </small> </small></label>
              <p class="mb-0" ng-if="specific_pmr_data.apa_acceptance != 'Invalid Date'" ng-bind="specific_pmr_data.apa_acceptance | date: 'mediumDate'"></p>
              <!-- <p class="mb-0" ng-if="specific_pmr_data.apa_acceptance == 'Invalid Date'" >NOT APPLICABLE</p> -->
              <p class="mb-0" ng-if="specific_pmr_data.mode_of_procurement == undefined || specific_pmr_data.mode_of_procurement == 'NP-53.1 TWO FAILED BIDDINGS' || specific_pmr_data.mode_of_procurement == 'NP-53.9 SMALL VALUE PROCUREMENT' || specific_pmr_data.mode_of_procurement == 'SHOPPING'" >NOT APPLICABLE</p>

              <p>
                <a ng-if="specific_pmr_data.apa_acceptance == 'Invalid Date' && specific_pmr_data.mode_of_procurement == 'COMPETITIVE BIDDING - FOR GOODS'" href="" style="text-transform: none !important;" class="text-warning" ng-click="pmr_update_single_data('apa_acceptance',specific_pmr_data.id)"> <i class="fa fa-pencil-square-o"></i> Update </a>

                <a ng-if="specific_pmr_data.apa_acceptance == 'Invalid Date' && specific_pmr_data.mode_of_procurement == 'COMPETITIVE BIDDING - FOR INFRASTRUCTURE'" href="" style="text-transform: none !important;" class="text-warning" ng-click="pmr_update_single_data('apa_acceptance',specific_pmr_data.id)"> <i class="fa fa-pencil-square-o"></i> Update </a>

                <a ng-if="specific_pmr_data.apa_acceptance == 'Invalid Date' && specific_pmr_data.mode_of_procurement == 'NP-53.12 COMMUNITY PARTICIPATION'" href="" style="text-transform: none !important;" class="text-warning" ng-click="pmr_update_single_data('apa_acceptance',specific_pmr_data.id)"> <i class="fa fa-pencil-square-o"></i> Update </a>

                <a ng-if="specific_pmr_data.apa_acceptance == 'Invalid Date' && specific_pmr_data.mode_of_procurement == 'NP-53.2 EMERGENCY CASES'" href="" style="text-transform: none !important;" class="text-warning" ng-click="pmr_update_single_data('apa_acceptance',specific_pmr_data.id)"> <i class="fa fa-pencil-square-o"></i> Update </a>
              </p>
            </div>
          </div>
          ...
          <div class="col-lg-3">
            <div class="form-group">
              <label style="color:#007bff;"><small class="col-form-label"> <small class="font-weight-bold"> Contractors Eval Conducted </small> </small></label>
              <p class="mb-0" ng-if="specific_pmr_data.date_contractors_eval_conducted != 'Invalid Date'" ng-bind="specific_pmr_data.date_contractors_eval_conducted | date: 'mediumDate'"></p>
              <!-- <p class="mb-0" ng-if="specific_pmr_data.date_contractors_eval_conducted == 'Invalid Date'" >NOT APPLICABLE</p> -->
              <p class="mb-0" ng-if="specific_pmr_data.mode_of_procurement == undefined || specific_pmr_data.mode_of_procurement == 'NP-53.1 TWO FAILED BIDDINGS' || specific_pmr_data.mode_of_procurement == 'NP-53.9 SMALL VALUE PROCUREMENT' || specific_pmr_data.mode_of_procurement == 'SHOPPING'" >NOT APPLICABLE</p>

              <p>
                <a ng-if="specific_pmr_data.date_contractors_eval_conducted == 'Invalid Date' && specific_pmr_data.mode_of_procurement == 'COMPETITIVE BIDDING - FOR GOODS'" href="" style="text-transform: none !important;" class="text-warning" ng-click="pmr_update_single_data('date_contractors_eval_conducted',specific_pmr_data.id)"> <i class="fa fa-pencil-square-o"></i> Update </a>

                <a ng-if="specific_pmr_data.date_contractors_eval_conducted == 'Invalid Date' && specific_pmr_data.mode_of_procurement == 'COMPETITIVE BIDDING - FOR INFRASTRUCTURE'" href="" style="text-transform: none !important;" class="text-warning" ng-click="pmr_update_single_data('date_contractors_eval_conducted',specific_pmr_data.id)"> <i class="fa fa-pencil-square-o"></i> Update </a>

                <a ng-if="specific_pmr_data.date_contractors_eval_conducted == 'Invalid Date' && specific_pmr_data.mode_of_procurement == 'NP-53.12 COMMUNITY PARTICIPATION'" href="" style="text-transform: none !important;" class="text-warning" ng-click="pmr_update_single_data('date_contractors_eval_conducted',specific_pmr_data.id)"> <i class="fa fa-pencil-square-o"></i> Update </a>

                <a ng-if="specific_pmr_data.date_contractors_eval_conducted == 'Invalid Date' && specific_pmr_data.mode_of_procurement == 'NP-53.2 EMERGENCY CASES'" href="" style="text-transform: none !important;" class="text-warning" ng-click="pmr_update_single_data('date_contractors_eval_conducted',specific_pmr_data.id)"> <i class="fa fa-pencil-square-o"></i> Update </a>
              </p>
            </div>
          </div>
          ...
          <div class="col-lg-3">
            <div class="form-group">
              <label style="color: #007bff !important;"><small class="col-form-label"> <small class="font-weight-bold"> Material Delivery Percentage </small> </small></label>
              <p class="mb-0" ng-bind="specific_pmr_data.delivery_percentage +'%'"></p>
            </div>
          </div>
          ...
          <div class="col-lg-3">
            <div class="form-group">
              <label style="color: #007bff !important;"><small class="col-form-label"> <small class="font-weight-bold"> Early Procurement Activity? </small> </small></label>
              <p class="mb-0" ng-bind="specific_pmr_data.early_procurement_activity"></p>
            </div>
          </div>
        ...
        <div class="row">
          ...
          <div class="col-lg-4">
            <div class="form-group">
              <label style="color:#007bff;"><small class="col-form-label"> <small class="font-weight-bold"> Total </small> </small></label>
              <p class="mb-0" ng-if="specific_pmr_data.abc_total && pmr_update_inputs == false" ng-bind="specific_pmr_data.abc_total | currency:'₱ '"></p>

              @verbatim
              <input ng-if="pmr_update_inputs == true" ng-model="specific_pmr_data_for_update.abc_total"  type="text" class="form-control" onkeypress="return (event.charCode == 8 || event.charCode == 0 || event.charCode == 13) ? 'Invalid Date' : event.charCode >= 48 && event.charCode <= 57" readOnly="true">
              @endverbatim
            </div>
          </div>
          ...
          <div class="col-lg-4">
            <div class="form-group">
              <label style="color:#007bff;"><small class="col-form-label"> <small class="font-weight-bold"> MOOE </small> </small></label>
              <p class="mb-0" ng-if="specific_pmr_data.abc_mooe && pmr_update_inputs == false" ng-model="specific_pmr_data.abc_mooe"></p>

              @verbatim
              <input ng-if="pmr_update_inputs == true" ng-model="specific_pmr_data_for_update.abc_mooe" type="text" class="form-control" onkeypress="return (event.charCode == 8 || event.charCode == 0 || event.charCode == 13) ? 'Invalid Date' : event.charCode >= 48 && event.charCode <= 57" readOnly="true">
              @endverbatim
            </div>
          </div>
          ...
          <div class="col-lg-4">
            <div class="form-group">
              <label style="color:#007bff;"><small class="col-form-label"> <small class="font-weight-bold"> CO </small> </small></label>
              <p class="mb-0" ng-if="specific_pmr_data.abc_co && pmr_update_inputs == false" ng-bind="specific_pmr_data.abc_co | currency:'₱ '"></p>

              @verbatim
              <input ng-if="pmr_update_inputs == true" ng-model="specific_pmr_data_for_update.abc_co" type="text" class="form-control" onkeypress="return (event.charCode == 8 || event.charCode == 0 || event.charCode == 13) ? 'Invalid Date' : event.charCode >= 48 && event.charCode <= 57" price>
              @endverbatim
            </div>
          </div>
        </div>
        ...
        <div class="row">
          ...
          <div class="col-lg-4">
            <div class="form-group">
              <label style="color:#007bff;"><small class="col-form-label"> <small class="font-weight-bold"> Total </small> </small></label>
              <p class="mb-0" ng-if="specific_pmr_data.contract_cost_total && pmr_update_inputs == false" ng-bind="specific_pmr_data.contract_cost_total | currency:'₱ '"></p>

              @verbatim
              <input ng-if="pmr_update_inputs == true" ng-model="specific_pmr_data_for_update.contract_cost_total" type="text" class="form-control" onkeypress="return (event.charCode == 8 || event.charCode == 0 || event.charCode == 13) ? 'Invalid Date' : event.charCode >= 48 && event.charCode <= 57" readOnly="true" price>
              @endverbatim
            </div>
          </div>
          ...
          <div class="col-lg-4">
            <div class="form-group">
              ...
              <p class="mb-0" ng-if="specific_pmr_data.contract_cost_mooe && pmr_update_inputs == false" ng-bind="specific_pmr_data.contract_cost_mooe | currency:'₱ '"></p>
              
              @verbatim
              <input ng-if="pmr_update_inputs == true" ng-model="specific_pmr_data_for_update.contract_cost_mooe" type="text" class="form-control" onkeypress="return (event.charCode == 8 || event.charCode == 0 || event.charCode == 13) ? 'Invalid Date' : event.charCode >= 48 && event.charCode <= 57" readOnly="true">
              @endverbatim
            </div>
          </div>
          ...
          <div class="col-lg-4">
            <div class="form-group">
              ...
              <p class="mb-0" ng-if="specific_pmr_data.contract_cost_co && pmr_update_inputs == false" ng-bind="specific_pmr_data.contract_cost_co | currency:'₱ '"></p>
              @verbatim
              <input ng-if="pmr_update_inputs == true" ng-model="specific_pmr_data_for_update.contract_cost_co" type="text" class="form-control" onkeypress="return (event.charCode == 8 || event.charCode == 0 || event.charCode == 13) ? 'Invalid Date' : event.charCode >= 48 && event.charCode <= 57" price>
              @endverbatim
            </div>
          </div>

          <div class="col-lg-12" ng-if="pmr_update_inputs == false">
            <div class="form-group">
              <label style="color:#007bff;"><small class="col-form-label"> <small class="font-weight-bold"> List of Invited Obervers </small> </small></label>
              <div class="row">
        ...
        <div class="row">
          ...
          <div class="col-lg-4" ng-if="pmr_update_inputs == false">
            <div class="form-group">
              <label style="color:#007bff;"><small class="col-form-label"> <small class="font-weight-bold"> Pre-bid Conf </small> </small></label>
              <p class="mb-0" ng-if="specific_pmr_data.io_prebid_con != 'Invalid Date'" ng-bind="specific_pmr_data.io_prebid_con | date: 'mediumDate'"></p>
              <p class="mb-0" ng-if="specific_pmr_data.io_prebid_con == 'Invalid Date'">NOT APPLICABLE</p>
              <a ng-if="specific_pmr_data.io_prebid_con == 'Invalid Date' && specific_pmr_data.mode_of_procurement == 'COMPETITIVE BIDDING - FOR GOODS' || specific_pmr_data.mode_of_procurement == 'COMPETITIVE BIDDING - FOR INFRASTRUCTURE'" href="" style="text-transform: none !important;" class="text-warning" ng-click="pmr_update_single_data('io_prebid_con',specific_pmr_data.id)"> <i class="fa fa-pencil-square-o"></i> Update </a>
            </div>
          </div>
          ...
          <div class="col-lg-4" ng-if="pmr_update_inputs == false">
            <div class="form-group">
              <label style="color:#007bff;"><small class="col-form-label"> <small class="font-weight-bold"> Eligibility Check </small> </small></label>
              <p class="mb-0" ng-if="specific_pmr_data.io_eligibility_check != 'Invalid Date'" ng-bind="specific_pmr_data.io_eligibility_check | date: 'mediumDate'"></p>
              <p class="mb-0" ng-if="specific_pmr_data.io_eligibility_check == 'Invalid Date'">NOT APPLICABLE</p>
              <a ng-if="specific_pmr_data.io_eligibility_check == 'Invalid Date' && specific_pmr_data.mode_of_procurement == 'COMPETITIVE BIDDING - FOR GOODS' || specific_pmr_data.mode_of_procurement == 'COMPETITIVE BIDDING - FOR INFRASTRUCTURE'" href="" style="text-transform: none !important;" class="text-warning" ng-click="pmr_update_single_data('io_eligibility_check',specific_pmr_data.id)"> <i class="fa fa-pencil-square-o"></i> Update </a>
            </div>
          </div>
          ...
          <div class="col-lg-4" ng-if="pmr_update_inputs == false">
            <div class="form-group">
              <label style="color:#007bff;"><small class="col-form-label"> <small class="font-weight-bold"> Sub/Open of Bids </small> </small></label>
              <p class="mb-0" ng-if="specific_pmr_data.io_open_of_bids != 'Invalid Date'" ng-bind="specific_pmr_data.io_open_of_bids | date: 'mediumDate'"></p>
              <p class="mb-0" ng-if="specific_pmr_data.io_open_of_bids == 'Invalid Date'">NOT APPLICABLE</p>
              <a ng-if="specific_pmr_data.io_open_of_bids == 'Invalid Date' && specific_pmr_data.mode_of_procurement == 'COMPETITIVE BIDDING - FOR GOODS' || specific_pmr_data.mode_of_procurement == 'COMPETITIVE BIDDING - FOR INFRASTRUCTURE'" href="" style="text-transform: none !important;" class="text-warning" ng-click="pmr_update_single_data('io_open_of_bids',specific_pmr_data.id)"> <i class="fa fa-pencil-square-o"></i> Update </a>
            </div>
          </div>
          ...
          <div class="col-lg-4" ng-if="pmr_update_inputs == false">
            <div class="form-group">
              <label style="color:#007bff;"><small class="col-form-label"> <small class="font-weight-bold"> Bid Evaluation </small> </small></label>
              <p class="mb-0" ng-if="specific_pmr_data.io_bid_eval != 'Invalid Date'" ng-bind="specific_pmr_data.io_bid_eval | date: 'mediumDate'"></p>
              <p class="mb-0" ng-if="specific_pmr_data.io_bid_eval == 'Invalid Date'">NOT APPLICABLE</p>
              <a ng-if="specific_pmr_data.io_bid_eval == 'Invalid Date' && specific_pmr_data.mode_of_procurement == 'COMPETITIVE BIDDING - FOR GOODS' || specific_pmr_data.mode_of_procurement == 'COMPETITIVE BIDDING - FOR INFRASTRUCTURE'" href="" style="text-transform: none !important;" class="text-warning" ng-click="pmr_update_single_data('io_bid_eval',specific_pmr_data.id)"> <i class="fa fa-pencil-square-o"></i> Update </a>
            </div>
          </div>
          ...
          <div class="col-lg-4" ng-if="pmr_update_inputs == false">
            <div class="form-group">
              <label style="color:#007bff;"><small class="col-form-label"> <small class="font-weight-bold"> Post Qual </small> </small></label>
              <p class="mb-0" ng-if="specific_pmr_data.io_post_qual != 'Invalid Date'" ng-bind="specific_pmr_data.io_post_qual | date: 'mediumDate'"></p>
              <p class="mb-0" ng-if="specific_pmr_data.io_post_qual == 'Invalid Date'">NOT APPLICABLE</p>
              <a ng-if="specific_pmr_data.io_post_qual == 'Invalid Date' && specific_pmr_data.mode_of_procurement == 'COMPETITIVE BIDDING - FOR GOODS' || specific_pmr_data.mode_of_procurement == 'COMPETITIVE BIDDING - FOR INFRASTRUCTURE'" href="" style="text-transform: none !important;" class="text-warning" ng-click="pmr_update_single_data('io_post_qual',specific_pmr_data.id)"> <i class="fa fa-pencil-square-o"></i> Update </a>
            </div>
          </div>

          <div class="col-lg-4" ng-if="pmr_update_inputs == false">
            <div class="form-group">
              <label style="color:#007bff;"><small class="col-form-label"> <small class="font-weight-bold"> Delivery/ Accept </small> </small></label>
              <p class="mb-0" ng-if="specific_pmr_data.delivery != 'Invalid Date'" ng-bind="specific_pmr_data.delivery | date: 'mediumDate'"></p>
              <p class="mb-0" ng-if="specific_pmr_data.delivery == 'Invalid Date'">NOT APPLICABLE</p>
              <a ng-if="specific_pmr_data.delivery == 'Invalid Date' && specific_pmr_data.mode_of_procurement == 'COMPETITIVE BIDDING - FOR GOODS' || specific_pmr_data.mode_of_procurement == 'COMPETITIVE BIDDING - FOR INFRASTRUCTURE'" href="" style="text-transform: none !important;" class="text-warning" ng-click="pmr_update_single_data('delivery',specific_pmr_data.id)"> <i class="fa fa-pencil-square-o"></i> Update </a>
            </div>
          </div>

          <div class="col-lg-12">

            <div class="form-group" ng-if="pmr_update_inputs == true">
              <label style="color: #007bff !important;"><small class="col-form-label"> <small class="font-weight-bold"> Remarks (Explaining changes from the APP) </small> </small></label>
              <textarea ng-model="specific_pmr_data.remarks" maxlength="2500" rows="10" cols="50" class="form-control" style="resize: none;"></textarea>
            </div>

            <div class="table-responsive" ng-if="pmr_update_inputs == false">
              <label style="color:#007bff;"><small class="col-form-label"> <small class="font-weight-bold"> Remarks (Explaining changes from the APP) </small> </small></label>
              <!-- <p class="mb-0" ng-bind="specific_pmr_data.remarks | uppercase"></p> -->
              <!-- <p class="mb-0" ng-if="specific_pmr_data.remarks == 'Invalid Date'">NOT APPLICABLE</p> -->

              <table class="table table-bordered" ng-if="specific_pmr_data.sp_pmr_remarks_logs.length > 0">
                <thead class="thead-dark">
                  <tr style="font-size: 10px;">
                    <th scope="col">Date</th>
                    <th scope="col">Event</th>
                    <th scope="col">Remarks</th>
                    <th scope="col">Delivery Percentage</th>
                  </tr>
                </thead>
                <tbody>
                  <tr ng-repeat="data in specific_pmr_data.sp_pmr_remarks_logs" style="font-size: 10px;">
                    <td>
                      <span ng-bind="data.created_at | date:'mediumDate'"></span>
                    </td>
                    <td>
                    ...
                    <td> <span ng-bind="data.pmr_remarks | uppercase"></span> </td>
                    <td> <span ng-bind="data.delivery_percentage+'%'"></span> </td>
                  </tr>
                </tbody>
              </table>
            </div>
        ...
        <div class="row">
          <div class="col mt-2">
            <h4 class="text-danger">Procurement Focal Comments/Issues/Concern/Remarks</h4>
            <p ng-if="specific_pmr_data.sp_pmr_logs.length == 0">No comments/issues/Concerns/Remarks as of the moment</p>
            <table class="table table-hover" ng-if="specific_pmr_data.sp_pmr_logs.length > 0">
              <thead>
                <tr>
                  <th scope="col">Date</th>
              ...
              <tbody>
                <tr ng-repeat="data in specific_pmr_data.sp_pmr_logs">
                  <th ng-bind="data.created_at | date:'mediumDate'"></th>
                  <td ng-bind="data.pmr_comments"></td>
                  <td ng-class="{'text-success' : data.status == 'Complied'}" ng-bind="data.status"></td>
                </tr>
              </tbody>
            </table>
            <br>
      ...
      <div class="modal-footer justify-content-between" style="padding: 20px 30px 30px 30px !important;">
        <button ng-if="pmr_update_inputs == true" type="button" class="btn rounded-0 btn-outline-secondary mr-auto" ng-click="pmr_update(2,specific_pmr_data)">Back <i class="fa fa-chevron-left"></i></button>

        <button ng-if="pmr_update_inputs == false" type="button" class="btn rounded-0 btn-outline-warning" ng-click="pmr_update(1,specific_pmr_data)">Update <i class="fa fa-refresh"></i></button>
        <!-- fetch_specific_pmr_data_for_update(specific_pmr_data) -->

        <button ng-if="pmr_update_inputs == true" type="button" class="btn rounded-0 btn-outline-success" ng-click="pmr_update_data(specific_pmr_data_for_update.id,specific_pmr_data_for_update.mode_of_procurement,specific_pmr_data_for_update.code,specific_pmr_data_for_update.fund_source,specific_pmr_data_for_update.abc_total,specific_pmr_data_for_update.abc_mooe,specific_pmr_data_for_update.abc_co,specific_pmr_data_for_update.contract_cost_total,specific_pmr_data_for_update.contract_cost_mooe,specific_pmr_data_for_update.contract_cost_co)">Update <i class="fa fa-refresh"></i></button>
        <button type="button" class="btn rounded-0 btn-outline-secondary" data-dismiss="modal" ng-click="pmr_forupdate(2,specific_pmr_data)">Close <i class="fa fa-times-circle"></i></button>
      </div>
    </div>
  </div>
</div>
