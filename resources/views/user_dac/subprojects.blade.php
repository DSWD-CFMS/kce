  ...
  <div class="table-responsive" style="height: 400px;">
      <table class="table table-bordered1">
        <tbody style="overflow-y: auto !important; overflow-x: none !important;">
          <tr style="font-size: 11px;" ng-repeat="all_data in bars = (my_modality.data | filter:search_data_modality) track by $index">
                ...
                <div class="col-lg-6">
                  <div class="row">
                      ...
                      <small class="text-label-blue"> <b>Target date of completion</b> </small>
                          ...
                          <p class="mb-0" ng-if="specific_sp_data.sp[0].sp_target_date_of_completion == null">
                        ...
                        <div class="col-lg-4 hov">
                          ...
                          <p class="mb-0" ng-if="specific_sp_data.sp[0].sp_actual_date_completed == null || specific_sp_data.sp[0].sp_actual_date_completed == '0000-00-00 00:00:00'">
