									...
									<div class="row">
											...
											<small class="text-label-blue"> <b>Target date of completion</b> </small><br>
												...
												<div class="col-lg-4 hov">
													...
													<p class="mb-0" ng-if="specific_sp_data.sp[0].sp_actual_date_completed == '0000-00-00 00:00:00' || specific_sp_data.sp[0].sp_actual_date_completed == '' || specific_sp_data.sp[0].sp_actual_date_completed == null">
