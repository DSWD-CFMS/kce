      ...
      <div class="widget-head-color-box rounded-0 p-lg pt-3">
        <div class="row">
          ...
          <div id="info" ng-if="try_update_profileinfo_btn == false" ng-cloak>
            ...
            <p class="mt-0">
              This account can overseen KKB,IP CDD,MAKILAHOK,NCDDP,CCL & L&E. Also this account can received sms updates of Subprojects from all DAC's and RPMO Focal and Consolidate Data from the database of all modalities.
            </p>
            ...
            <div class="row pb-3 mt-3">
              ...
              <div class="col-md-4">
                  ...
                  <h5 class="mb-0"><strong ng-bind="DAC_count1"></strong></h5>
                  <span>DAC</span>
              </div>
              <div class="col-md-4">
                  <span class="bar">5,3,2,-1,-3,-2,2,3,5,2</span>
                  <h5 class="mb-0"><strong ng-bind="RPMO_count1"></strong> </h5>
                  <span>RPMO</span>
              </div>
            </div>
          </div>
