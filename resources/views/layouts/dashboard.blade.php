...
<head>
  ...
  <body ng-app="Main_Function" ng-controller="DAC_Controller" ng-class="{'mini-navbar': mini_navbar == true}">
  ...
  <body ng-app="Main_Function" ng-controller="MAINSTREAM_Controller" ng-class="{'mini-navbar': mini_navbar == true}">
  @elseif(Auth::user()->role=="PROCUREMENT")
  <body ng-app="Main_Function" ng-controller="PROCUREMENT_Controller" ng-class="{'mini-navbar': mini_navbar == true}">
  @endif
            ...
            <li class="nav-header">
              <div class="dropdown profile-element">
                  ...
                  <a data-toggle="dropdown" class="dropdown-toggle" href="">
                      ...
                      <span class="text-muted text-xs block"> DAC <b class="caret"></b></span>
                  </a>
                  <ul class="dropdown-menu animated fadeInRight m-t-xs">
                      <li><a class="dropdown-item" href="{{ url('/dac/routes/profile') }}">Profile</a></li>
                  </ul>
                </div>
                <div class="logo-element">
                  <a href="{{ url('/dac/routes/profile') }}">
                    <img ng-if="PhotoObj.length == 0" alt="image" class="rounded-circle" style="height: 50px; width: 50px; border-radius: 50px; object-fit: cover;" src="https://image.flaticon.com/icons/svg/747/747376.svg" ng-cloak>
                    <img ng-if="PhotoObj.length > 0" alt="image" class="rounded-circle" style=" cursor: pointer; height: 50px; width: 50px; border-radius: 50px; object-fit: cover;" src="/get_profile_photo/{{Auth::user()->id}}" ng-cloak>
                  </a>
                </div>
              ...
              <li>
                  <a href="{{ url('/dac/routes') }}"><i class="fa fa-tachometer"></i> <span class="nav-label">Dashboard</span></a>
              </li>

              <li>
                  <a href="{{ url('/dac/routes/show_modality') }}"><i class="fa fa-list-alt"></i> <span class="nav-label">Modality</span></a>
              </li>

              <li>
                  <a href="" ng-click="fetch_dac_ceac()"><i class="fa fa-fw fa-slideshare"></i>
                    <span class="nav-label" ng-class="{'text-warning': fetch_dac_ceac_div == true, 'text-muted': fetch_dac_ceac_div == false}">CEAC</span>
                  </a>
              </li>

              <li>
                  <a href="{{ url('/dac/routes/show_file') }}" ng-class="{'text-warning': fetch_dac_upload_div == true, 'text-muted': fetch_dac_upload_div == false}"><i class="fa fa-archive"></i>
                    <span class="nav-label" >Files</span>
                  </a>
              </li>

              <li>
                  <a href="{{ url('/dac/routes/test') }}"><i class="fa fa-list-alt"></i> <span class="nav-label">TEST</span></a>
              </li>
          </ul>
      </div>
    </nav>
      ...
      <div class="sidebar-collapse">
          <ul class="nav metismenu" id="side-menu">
            <li class="nav-header">
              ...
              <li>
                  <a href="{{ url('/rpmo/routes/show_file') }}" ><i class="fa fa-archive"></i> <span class="nav-label">Files</span></a>
              </li>
          </ul>
      </div>
    </nav>
    ...
    <nav class="navbar-default navbar-static-side" role="navigation" >
      <div class="sidebar-collapse">
          <ul class="nav metismenu" id="side-menu">
            <li class="nav-header">
              <div class="dropdown profile-element">
                  <img alt="image" class="rounded-circle" style="height: 50px; width: 50px; border-radius: 50px; object-fit: cover;" src="{{ asset('images/profile.jpg') }}"/>
                  <a data-toggle="dropdown" class="dropdown-toggle" href="">
                      <span class="block m-t-xs font-bold">{{Auth::user()->Fname}} {{Auth::user()->Lname}}</span>
                      <span class="text-muted text-xs block"> MAINSTREAM <b class="caret"></b></span>
                  </a>
                  <ul class="dropdown-menu animated fadeInRight m-t-xs">
              ...
              <li>
                  <a href="" ng-class="{'text-warning': fetch_rpmo_dashboard_div == true}" ng-click="fetch_mainstream_dashboard()"><i class="fa fa-tachometer"></i> <span class="nav-label">Dashboard</span></a>
              </li>

              <li>
                  <a href="" ng-class="{'text-warning': fetch_rpmo_reports_div == true}" ng-click="fetch_mainstream_spcr()"><i class="fa fa-fw fa-folder"></i>
                    <span class="nav-label" ng-class="{'text-warning': fetch_rpmo_reports_div == true}">SPCR's</span>
                  </a>
              </li>

              <li>
                  <a href="" ng-class="{'text-warning': fetch_rpmo_upload_div == true}" ng-click="fetch_mainstream_upload()"><i class="fa fa-archive"></i>
                    <span class="nav-label" ng-class="{'text-warning': fetch_rpmo_upload_div == true}">Files</span>
                  </a>
              </li>
          </ul>
      </div>
          ...
          <ul class="nav metismenu" id="side-menu">
            <li class="nav-header">
              <div class="dropdown profile-element">
                  ...
                  <a data-toggle="dropdown" class="dropdown-toggle" href="">
                      <span class="block m-t-xs font-bold">{{Auth::user()->Fname}} {{Auth::user()->Lname}}</span>
                      <span class="text-muted text-xs block"> PROCUREMENT <b class="caret"></b></span>
                  </a>
                  <ul class="dropdown-menu animated fadeInRight m-t-xs">
                      <li><a class="dropdown-item" href="{{ url('/procurement/routes/profile') }}">Profile</a></li>
                  </ul>
                </div>
                <div class="logo-element">
                  <a href="{{ url('/procurement/routes/profile') }}">
                    <img ng-if="PhotoObj.length == 0" alt="image" class="rounded-circle" style="height: 50px; width: 50px; border-radius: 50px; object-fit: cover;" src="https://image.flaticon.com/icons/svg/747/747376.svg" ng-cloak>
                    <img ng-if="PhotoObj.length > 0" alt="image" class="rounded-circle" style=" cursor: pointer; height: 50px; width: 50px; border-radius: 50px; object-fit: cover;" src="/get_profile_photo/{{Auth::user()->id}}" ng-cloak>
                  </a>
                </div>
              ...
              <li>
                  <a href="{{ url('/procurement/routes') }}" ng-class="{'text-warning': fetch_rpmo_dashboard_div == true}"><i class="fa fa-tachometer"></i> <span class="nav-label">Dashboard</span></a>
              </li>

              <li>
                  <a href="{{ url('/procurement/routes/show_modality') }}" ><i class="fa fa-list-alt"></i> <span class="nav-label">Modality</span></a>
              </li>

              <li>
                  <a href="{{ url('/procurement/routes/show_file') }}" ><i class="fa fa-archive"></i> <span class="nav-label">Files</span></a>
              </li>
          </ul>
      </div>
    </nav>
...
<!--     <script src="https://unpkg.com/bootstrap-table@1.18.0/dist/bootstrap-table.min.js"></script>
    ...
    @if(Auth::user()->role=="DAC")
      <script type="text/javascript" src="{{ asset('/js/dac_functions.js') }}"></script>
    @elseif(Auth::user()->role=="RPMO")
      <script type="text/javascript" src="{{ asset('/js/rpmo_functions.js') }}"></script>
    @elseif(Auth::user()->role=="MAINSTREAM")
      <script type="text/javascript" src="{{ asset('/js/mainstream_functions.js') }}"></script>
    @elseif(Auth::user()->role=="PROCUREMENT")
      <script type="text/javascript" src="{{ asset('/js/procurement_functions.js') }}"></script>
    @else
    @endif
