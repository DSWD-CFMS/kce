      ...
      <div class="sidebar-collapse">
          <ul class="nav metismenu" id="side-menu">
            <li class="nav-header">
              ...
              <li>
                  <a href="{{ url('/dac/routes/files') }}" ng-class="{'text-warning': fetch_dac_upload_div == true, 'text-muted': fetch_dac_upload_div == false}"><i class="fa fa-archive"></i>
...
<!--     <script src="https://unpkg.com/bootstrap-table@1.18.0/dist/bootstrap-table.min.js"></script>
    ...
    <script type="text/javascript" src="{{ asset('/js/angular-routes/dac-routes.js') }}"></script>
