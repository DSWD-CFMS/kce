...
return [
    ...
    */
    ...
    'connections' => [
        ...
        'mysql2K20' => [
            'driver' => env('DB_CONNECTION_2K20'),
            'url' => env('DATABASE_URL'),
            'host' => env('DB_HOST_2K20'),
            'port' => env('DB_PORT_2K20'),
            'database' => env('DB_DATABASE_2K20'),
            'username' => env('DB_USERNAME_2K20'),
            'password' => env('DB_PASSWORD_2K20'),
            'unix_socket' => env('DB_SOCKET', ''),
            'charset' => 'utf8mb4',
            'collation' => 'utf8mb4_unicode_ci',
            'prefix' => '',
        ...
        'mysql2K21' => [
            'driver' => env('DB_CONNECTION_2K21'),
            'url' => env('DATABASE_URL'),
            'host' => env('DB_HOST_2K21'),
            'port' => env('DB_PORT_2K21'),
            'database' => env('DB_DATABASE_2K21'),
            'username' => env('DB_USERNAME_2K21'),
            'password' => env('DB_PASSWORD_2K21'),
            'unix_socket' => env('DB_SOCKET', ''),
            'charset' => 'utf8mb4',
            'collation' => 'utf8mb4_unicode_ci',
            'prefix' => '',
