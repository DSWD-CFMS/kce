...
class RPMO_Controller extends Controller
{
    ...
    public function set_date_start(Request $req){
        $querry1 = DB::select( DB::raw(" UPDATE `sp` SET `sp_date_started`=".$req->date." ,`sp_status` = 'On-going' WHERE `sp_id` =".$req->id." ;") );
        $querry2 = DB::select( DB::raw(" UPDATE `Assigned_sp` SET `sp_status` = 'On-going' WHERE `sp_id` =".$req->id." ;") );
